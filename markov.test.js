...
describe('markov machine', function () {
    test('chains makes chains', function () {
    ...
    test('rando picks from array', function () {
        console.log(MarkovMachine.rando([1, 1, 1]))
        expect(MarkovMachine.rando([1, 1, 1])).toEqual(1);
        expect([1, 2, 3]).toContain(MarkovMachine.rando([1, 2, 3]));
    });
...
// where as I did copy the solutions and code I went through them
// and understand them.  And I'm going to move forward and
// practice a bit more.  Should have more free time fairly soon
// moving closer to this job hopefully.